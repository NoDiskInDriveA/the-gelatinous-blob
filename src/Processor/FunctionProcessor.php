...
use Nodiskindrivea\Gelatinous\Visitor\RelocateEntrypointFunctionToGlobal;
...
class FunctionProcessor implements EntityProcessor
{
    ...
    private function traverse(string $fqn, array $stmts): ProcessedEntity
    {
        ...
        $traverser->addVisitor(new RelocateEntrypointFunctionToGlobal($this->entryPointFqn));
